    ...
    <>
      <TextItemWrapper>
        ...
        <TextValue fontSize={'1rem'}>
          <BaseCurrencyView type="id" value={token?.price} numeralFormat={'0,0'} />
        </TextValue>
      </TextItemWrapper>
      <TextItemWrapper>
        <TextLabel>
        ...
        <TextValue fontSize={'1rem'}>
          <BaseCurrencyView type="id" value={token?.mcap} numeralFormat={'0,0'} />
        </TextValue>
      </TextItemWrapper>
      <TextItemWrapper>
        <TextLabel>
        ...
        <TextValue fontSize={'1rem'}>
          <BaseCurrencyView type="id" value={token?.trading} numeralFormat={'0,0'} />
        </TextValue>
      </TextItemWrapper>
      <TextItemWrapper>
        <TextLabel>
        ...
        <TextValue fontSize={'1rem'}>
          <BaseCurrencyView type="id" value={token?.low_24h} numeralFormat={'0,0'} />
        </TextValue>
        <TextValue fontSize={'1rem'}>
          <BaseCurrencyView type="id" value={token?.high_24h} numeralFormat={'0,0'} />
        </TextValue>
      </TextItemWrapper>
    </>
  )
