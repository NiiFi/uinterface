...
export default function PoolInvestModal() {
  ...
  return (
    <Modal isOpen={poolInvestModalOpen} onDismiss={togglePoolInvestModal} minHeight={false} maxHeight={90}>
      <Wrapper>
        <UpperSection>
          ...
          {account ? (
            <ButtonPrimary disabled={!sufficientBalance && hasInputAmount} marginTop="1rem">
              <Trans>INVEST</Trans>
            </ButtonPrimary>
          ) : (
            <ButtonPrimary marginTop="1rem" onClick={toggleWalletModal}>
