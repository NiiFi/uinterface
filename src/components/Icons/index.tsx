...
export function GenericLogo({ width = 32, height = 32, ...rest }: IconProps) {
  return (
    <svg width={width} height={height} viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <g fill="none" fillRule="evenodd">
        <circle cx="16" cy="16" fill="#F7FDFC" fillRule="nonzero" r="16" />
        <path
