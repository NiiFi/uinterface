...
export function DarkModeLogo({ width = 32, height = 25, color = 'currentColor', ...rest }: IconProps) {
  return (
...
export function LightModeLogo({ width = 24, height = 24, color = 'currentColor', ...rest }: IconProps) {
  return (
    <svg width={width} height={height} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...rest}>
      <circle cx="12" cy="12" r="5" stroke="#0C443F" strokeOpacity="0.6" strokeWidth="2" />
      <path
